...
import MigratoryDataClient from 'migratorydata-client'
        ...
        <div class="row">
            <div class="col-2">
                ...
                <div class="btn-group-vertical">
                    <input @click="selectEndpoint(null)" type="radio" class="btn-check" name="options" id="overview"
                        autocomplete="off" checked>
                    <label class="btn btn-light text-start mb-1 mt-3" for="overview"
            ...
            <div class="col-8 mt-3">
                ...
                <div class="row mt-3">
                    <div class="mb-4">
                        <span class="pe-3">
                            <i id="connectStatus" class="fs-6 bi bi-circle-fill" :style="{ color: activeColor }"></i> Last
                        ...
                        <div class="tab-panels">
                            ...
                            <section id="code" class="tab-panel">
                                <div v-if="selectedEndpoint != null" class="stepper d-flex flex-column">
                                    ...
                                    <div class="alert alert-warning alert-dismissible fade show col-md-8 mb-4" role="alert">
                                        ...
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"
                                            v-on:click="app_creation_failed = false"></button>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <ul class="nav nav-pills my-5" id="myTab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button v-on:click="selectApi('java')" class="nav-link" id="java-tab"
                                                        data-bs-toggle="tab" data-bs-target="#java-tab-pane" type="button"
                                                        role="tab" aria-controls="java-tab-pane" aria-selected="true">
                                                        <img height="32"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button v-on:click="selectApi('ios')" class="nav-link" id="ios-tab"
                                                        data-bs-toggle="tab" data-bs-target="#ios-tab-pane" type="button"
                                                        role="tab" aria-controls="ios-tab-pane" aria-selected="false">
                                                        <img height="32"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button v-on:click="selectApi('cpp')" class="nav-link" id="cpp-tab"
                                                        data-bs-toggle="tab" data-bs-target="#cpp-tab-pane" type="button"
                                                        role="tab" aria-controls="cpp-tab-pane" aria-selected="false">
                                                        <img height="32"
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button v-on:click="selectApi('php')" class="nav-link" id="php-tab"
                                                        data-bs-toggle="tab" data-bs-target="#php-tab-pane" type="button"
                                                        role="tab" aria-controls="php-tab-pane" aria-selected="false">
                                                        <img height="32"
                                                            src="data:image/png;base64,">
                                                        <br>PHP
                                                    </button>
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button v-on:click="selectApi('rest')" class="nav-link" id="rest-tab"
                                                        data-bs-toggle="tab" data-bs-target="#rest-tab-pane" type="button"
                                                        role="tab" aria-controls="rest-tab-pane" aria-selected="false">
                                                        <img height="32"
                                    ...
                                    <div v-if="selectedCode == 'java'">
                                        <java-code :endpoint="selectedEndpoint" :server="server" :token="token"></java-code>
                                    </div>
